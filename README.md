...
This integration uses the same public, keyless tracking endpoint as the Österreichische Post consumer website and app. It is not affiliated with, endorsed by, or supported by Österreichische Post AG.
