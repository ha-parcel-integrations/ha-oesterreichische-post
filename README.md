...
[![Downloads](https://img.shields.io/github/downloads/ha-parcel-integrations/ha-oesterreichische-post/total.svg)](https://github.com/ha-parcel-integrations/ha-oesterreichische-post/releases)
...
Instead of polling Österreichische Post at the same rate around the clock,
...
- **Fully stopped** — nothing is tracked, or every tracked parcel has been
  ...
  `oesterreichische_post.track_parcel` service, or a dashboard button)
  resumes polling immediately.
- A small, fixed per-hub offset is added on top, so not every Österreichische
  Post hub out there polls at exactly the same second.
...
This is an independent, community-built project. It is not affiliated with, endorsed by, sponsored by, or supported by Österreichische Post, Home Assistant, or any other third party referenced in this project. Please don't contact Österreichische Post for support with this integration.
...
This integration may rely on public, unofficial, or undocumented carrier interfaces, accessed with your own account or API key where required. These may change or be withdrawn without notice and may be subject to Österreichische Post's terms. Data is sent only to Österreichische Post's own services or those of its group; this project operates no servers of its own. You are responsible for ensuring that your use complies with applicable law and those terms. Use is at your own risk; see the [licence](LICENSE) for warranty limitations.

This integration uses the same public, keyless tracking endpoint as the Österreichische Post consumer website and app.
