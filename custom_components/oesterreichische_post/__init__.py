"""Österreichische Post parcel tracker custom component for Home Assistant."""
...
from .api import OesterreichischePostApiClient
from .const import PLATFORMS
from .coordinator import OesterreichischePostCoordinator, _refresh_interval
...
@dataclass
class OesterreichischePostData:
    """Runtime data attached to the Österreichische Post config entry."""

    client: OesterreichischePostApiClient
    coordinator: OesterreichischePostCoordinator


type OesterreichischePostConfigEntry = ConfigEntry[OesterreichischePostData]
...
async def async_setup_entry(hass: HomeAssistant, entry: OesterreichischePostConfigEntry) -> bool:
    ...
    entry.runtime_data = OesterreichischePostData(client=client, coordinator=coordinator)
...
async def async_unload_entry(hass: HomeAssistant, entry: OesterreichischePostConfigEntry) -> bool:
    """Unload the Österreichische Post config entry."""
