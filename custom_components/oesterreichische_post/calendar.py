"""Calendar platform for the Österreichische Post parcel tracker integration."""
...
async def async_setup_entry(
    ...
    """Set up the Österreichische Post deliveries calendar from a config entry."""
    async_add_entities([OesterreichischePostDeliveriesCalendar(entry.runtime_data.coordinator, entry)])


class OesterreichischePostDeliveriesCalendar(CoordinatorEntity[OesterreichischePostCoordinator], CalendarEntity):
    """A read-only calendar of expected Österreichische Post deliveries.
    ...
    def _events(self) -> list[CalendarEvent]:
        ...
        for parcel in self.coordinator.data or []:
            ...
            summary = sender or (f"Parcel {barcode}" if barcode else "Österreichische Post parcel")
            description_parts = [
