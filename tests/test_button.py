"""Tests for the Österreichische Post refresh button."""
from unittest.mock import AsyncMock, MagicMock

from custom_components.oesterreichische_post.button import (
    OesterreichischePostRefreshButton,
)
...
async def test_refresh_button_requests_refresh():
    ...
    button = OesterreichischePostRefreshButton(entry)
